...
| PX-020.3 | Tooltip/copy updates (no new signals) | Copy review + pseudo-loc smoke (`PX-022.1` prep) | Replay artifacts include updated localized strings/screenshots for docs. |
