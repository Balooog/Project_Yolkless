...
4. Load the generated JSON summary and verify `economy_rate_avg`, `conveyor_backlog_avg`, `automation_target_last`, and `automation_panel_visible_ratio` exist under `stats`.
