...
3. Inspect the latest `user://logs/perf/tick_*.csv` and ensure the tail columns include the PX-020 fields (`economy_rate`, `_label`, `conveyor_backlog`, `_label`, `automation_target`, `automation_target_label`, `automation_panel_visible`).
