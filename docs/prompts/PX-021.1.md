...
3. Introduce `SandboxService` to listen for factor changes, run the lightweight 40×22 cellular sandbox, and emit `ci_changed(ci, bonus)`.
...
3. Sandbox tick stays ≤2 ms at 40×22.
