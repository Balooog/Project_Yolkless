...
@export var colors: Dictionary = {
	...
	"hud_label_normal": Color8(255, 255, 255, 255),
	"hud_label_warning": Color8(255, 179, 0, 255),
	"hud_label_critical": Color8(255, 23, 68, 255),
	"toast_bg": Color(0, 0, 0, 0.55),
	"tooltip_bg": Color(0.156, 0.156, 0.156, 0.85),
